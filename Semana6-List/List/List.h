...
#ifndef SEMANA6_LIST_LIST_H
#define SEMANA6_LIST_LIST_H

#include <iostream>
#include "../ErrorEmptyList/ErrorEmptyList.h"
#include "../ErrorNotDeleted/ErrorNotDeleted.h"
...
Node<T> *List<T>::erase(Node<T> *it) {
    if ((!empty()) && (it != 0)) {
        ...
        throw ErrorNotDeleted("Impossivel remover o elemento da Lista.");
}
...
void List<T>::erase(const T &value) {
    if (!empty()) {
        ...
        throw  ErrorEmptyList("Lista Vazia! Impossivel remover o elemento da Lista.");
}
